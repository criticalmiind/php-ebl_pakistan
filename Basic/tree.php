...
?>
<td colspan="2"><i class="fa fa-user-plus fa-4x" style="color:#D520BE"></i><p><?php echo $first_left_user ?></p></td>
<?php
}
?>
<?php 
...
?>
<td colspan="2"><i class="fa fa-user-plus fa-4x" style="color:#D520BE"></i><p><?php echo $first_right_user ?></p></td>
<?php
}
?>
</tr>
...
?>
<td><i class="fa fa-user-plus fa-4x" style="color:#361515"></i></td>
<?php
}
?>
<?php 

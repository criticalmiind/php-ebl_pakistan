...
if(isset($_GET['userid'])){
	...
	echo '<script>alert("Payment has paid");window.location.assign("income4.php");</script>';
}
?>
<!DOCTYPE html>
<html lang="en">
                	...
                	<div class="col-lg-12">
                    	<div class="table-responsive">
                        	<table class="table table-bordered table-striped">
                                ...
                                <tbody>
								<?php
                                	$query = mysqli_query($con,"select * from income where NOT current_bal=total_bal AND current_bal>=7200");
									if(mysqli_num_rows($query)>0){
										...
										?>
                                            ...
                                            <td><?php echo $total_bal; ?></td>
                                                ...
                                                <td><a href="income4.php?<?php echo 'userid='.$userid.'&amount='.$amount ?>">Send</a></td>
                                            </tr>
                                        <?php
											$i++;
										}
